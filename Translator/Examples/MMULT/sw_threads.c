...
void *parallel_function_1(void *arg)
{
    ...
    do{
        ...
        switch(tid){
            case __KERNEL_3: vTid = 0; if(ready = (!__sw_task_1[vTid])) break;
                              break;
            case __MAIN_KERNEL: vTid = 1; if(ready = (!__sw_task_1[vTid])) break;
                              break;
            case __KERNEL_1: vTid = 2; if(ready = (!__sw_task_1[vTid])) break;
                              break;
            case __KERNEL_2: vTid = 3; if(ready = (!__sw_task_1[vTid])) break;
                              break;
